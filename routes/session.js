...
module.exports.create = function(req, res, next) {
  User.authenticate(req.body.email, req.body.password, function(err, user) {
    ...
    if (user) {
      ...
      res.status(401).render('index', {message: 'Authentication failed', client_id: req.body.client_id || '', redirect: req.body.redirect || '', redirect_uri: req.body.redirect_uri || '', csrf: req.csrfToken()});
    }
  });
};
